...
%>
    ...
    <hr>
    <h1 align="center"><font color="#400040"><strong>全部合同</strong></font></h1>
...
%>
					<td><a href="hetongAction.do?method=readHeTong&htbh=${hetong.htbh}">查看</a></td>
<% 
	}
	if(user.getDeleteable()==1) {
%>
					<td><a href="hetongAction.do?method=deleteHeTong&htbh=${hetong.htbh }">删除</a></td>
<%
	}
 %>
				</tr>
